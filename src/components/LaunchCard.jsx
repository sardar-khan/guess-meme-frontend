                            ...
                            <div className={`${setSpace === 'medium' ? 'md:p-[8px]' : 'md:p-[15px]'} p-[5px] min-h-full border-[5px] border-t-[#7D73BF] border-l-[#7D73BF] border-b-[#fff] border-r-[#fff]`}>
                                ...
                                <div>
                                    <div className='flex justify-between items-end w-full mt-[7px] md:mt-[15px]'>
                                        ...
                                        <h5 className='PixelOperatorbold text-[10px] md:text-[13px]'>{coinData?.coin?.bonding_curve_progress || 0}% to {blockchainType === 'SOL' ? 'Radium' : 'Uniswap'}</h5>
                                    </div>
                                    ...
                                    <div className='relative overflow-hidden bg-[#E9E9E9] h-[10px] mt-1'>
                                        <div
                                            ...
                                            style={{ width: `${coinData?.coin?.bonding_curve_progress || 0}%` }}
                                        ></div>
                                    </div>
                                </div>
